<template>
  <a-modal v-model="show" title="修改产品答疑" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        ...
        <a-col :span="12">
          <a-form-item label='产品答疑类型' v-bind="formItemLayout">
            <a-select v-decorator="[
              'type',
              { rules: [{ required: true, message: '请输入产品答疑类型!' }] }
              ]">
              <a-select-option value="1">通知</a-select-option>
              <a-select-option value="2">产品答疑</a-select-option>
            </a-select>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label='产品答疑状态' v-bind="formItemLayout">
            <a-select v-decorator="[
              'rackUp',
              { rules: [{ required: true, message: '请输入产品答疑状态!' }] }
              ]">
        ...
        <a-col :span="24">
          <a-form-item label='产品答疑内容' v-bind="formItemLayout">
