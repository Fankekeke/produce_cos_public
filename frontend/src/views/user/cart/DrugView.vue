    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="drugInfo !== null">
      ...
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col :span="8"><b>所属分类：</b>
          <span v-if="drugInfo.category == 1">植物类</span>
          <span v-if="drugInfo.category == 2">畜禽类</span>
          <span v-if="drugInfo.category == 3">水产类</span>
        </a-col>
        <a-col :span="8"><b>农产品类别：</b>
          <span v-if="drugInfo.classification == 1">粮食</span>
          <span v-if="drugInfo.classification == 2">蔬菜</span>
          <span v-if="drugInfo.classification == 3">水果</span>
          <span v-if="drugInfo.classification == 4">养殖</span>
          <span v-if="drugInfo.classification == 5">其他</span>
        </a-col>
