    ...
    columns () {
      return [{
        ...
        customRender: (text, row, index) => {
          switch (text) {
            case 1:
              return <a-tag>粮食</a-tag>
            case 2:
              return <a-tag>蔬菜</a-tag>
            case 3:
              return <a-tag>水果</a-tag>
            case 4:
              return <a-tag>养殖</a-tag>
            case 5:
        ...
        customRender: (text, row, index) => {
          switch (text) {
            case 1:
              return <a-tag>植物类</a-tag>
            case 2:
              return <a-tag>畜禽类</a-tag>
            case 3:
              return <a-tag>水产类</a-tag>
            default:
              return '- -'
          }
        }
