<template>
  <a-modal v-model="show" title="销售店详情" @cancel="onClose" :width="800">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="pharmacyData !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">销售店信息</span></a-col>
        <a-col :span="8"><b>销售店名称：</b>
          {{ pharmacyData.name }}
        </a-col>
        <a-col :span="8"><b>销售店编号：</b>
          {{ pharmacyData.code }}
        </a-col>
      ...
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">销售店图片</span></a-col>
        <a-col :span="24">
          <a-upload
            name="avatar"
      ...
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 5px"><span style="font-size: 15px;font-weight: 650;color: #000c17">销售店位置</span></a-col>
      </a-row>
      <div>
