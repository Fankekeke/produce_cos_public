    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="orderData !== null">
      ...
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="8"><b>联系方式：</b>
          {{ orderData.mail ? orderData.mail : '- -' }}
        </a-col>
      </a-row>
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">产品答疑信息</span></a-col>
        <a-col :span="8"><b>产品答疑单号：</b>
          {{ medicationData.code }}
        </a-col>
        <a-col :span="8"><b>问题情况：</b>
      ...
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">购买农产品信息</span></a-col>
         <a-col :span="24">
